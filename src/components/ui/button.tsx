  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-semibold ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-harvest text-accent-foreground shadow-glow hover:scale-105 hover:shadow-elegant font-bold",
        grow: "bg-gradient-grow text-primary-foreground shadow-card hover:scale-105 hover:shadow-elegant font-bold",
        glass: "bg-background/10 backdrop-blur-md border border-background/30 text-primary-foreground hover:bg-background/20",
      },
      size: {
